class Taro::Types::ObjectTypes::PageInfoType < Taro::Types::ObjectType
  field :has_previous_page, type: 'Taro::Types::BaseType::Boolean', null: false, description: 'Whether there is a previous page of results'
  field :has_next_page, type: 'Taro::Types::BaseType::Boolean', null: false, description: 'Whether there is another page of results'
